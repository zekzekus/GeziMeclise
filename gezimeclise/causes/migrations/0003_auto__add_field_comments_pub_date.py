...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comments.pub_date'
        db.add_column(u'causes_comments', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 10, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comments.pub_date'
        db.delete_column(u'causes_comments', 'pub_date')
