...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cause'
        db.create_table(u'causes_cause', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.GeziUser'])),
        ...
        db.send_create_signal(u'causes', ['Cause'])

        # Adding M2M table for field supporters on 'Cause'
        m2m_table_name = db.shorten_name(u'causes_cause_supporters')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cause', models.ForeignKey(orm[u'causes.cause'], null=False)),
            ('geziuser', models.ForeignKey(orm[u'profiles.geziuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['cause_id', 'geziuser_id'])


    def backwards(self, orm):
        # Deleting model 'Cause'
        db.delete_table(u'causes_cause')

        # Removing M2M table for field supporters on 'Cause'
        db.delete_table(db.shorten_name(u'causes_cause_supporters'))
