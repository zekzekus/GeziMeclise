...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GeziUser.region'
        db.add_column(u'profiles_geziuser', 'region',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Region'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GeziUser.region'
        db.delete_column(u'profiles_geziuser', 'region_id')
