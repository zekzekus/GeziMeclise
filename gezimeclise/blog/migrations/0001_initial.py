...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'blog_post', (
            ...
            ('publisher', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.GeziUser'])),
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'publisher': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['profiles.GeziUser']"}),
