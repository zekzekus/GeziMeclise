...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'notifications_notification', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 22, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Notification.notification'
        db.alter_column(u'notifications_notification', 'notification', self.gf('django.db.models.fields.IntegerField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Notification.date_created'
        db.delete_column(u'notifications_notification', 'date_created')


        # Changing field 'Notification.notification'
        db.alter_column(u'notifications_notification', 'notification', self.gf('django.db.models.fields.CharField')(max_length=255))
